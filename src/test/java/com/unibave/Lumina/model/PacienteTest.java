...
class PacienteTest {
    ...
    void dadosPaciente(){
        ...
        assertEquals(STR."nome, cpf, dt_nascimento, crtSus, email, situacao, dt_cadastro = [Teste, 995.499.490-44, 2000-01-01, 18933001613, teste@teste.com, 1, \{LocalDate.now()}]", paciente.toString());
        System.out.println("\ntoString validado");
        System.out.println("====================================================================================================");
    }
    ...
    void construtor(){
        ...
        assertEquals(STR."nome, cpf, dt_nascimento, crtSus, email, situacao, dt_cadastro = [teste, 907.341.110-61, 1900-01-01, 18933001613, teste@teste.com.br, 1, \{LocalDate.now()}]", pacienteConstrutor.toString());
        System.out.println("\ntoString validado");
        System.out.println("====================================================================================================");
    }
}